/*1532586199,,JIT Construction: v4142988,ko_KR*/
...
try {
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with(this) {
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/bSTT5dUx9MY.js?version=42",
                    "Flash": {
                ...
                __d("sdk.XD", ["JSSDKXDConfig", "Log", "QueryString", "Queue", "UrlMap", "XDM", "guid", "isFacebookURI", "sdk.Content", "sdk.createIframe", "sdk.Event", "sdk.feature", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    ...
                    var E = m(),
                        F = c(),
                        G, H = !1,
                        I = "Facebook Cross Domain Communication Frame",
                        J = {},
                        K = new j();
                    s.setInQueue(K);
                ...
                __d("sdk.Auth", ["DOMWrapper", "Log", "ObservableMixin", "UrlMap", "guid", "sdk.Cookie", "sdk.createIframe", "sdk.feature", "sdk.getContextType", "sdk.Impressions", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.URI", "sdk.XD"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    __p && __p();
                    var v = "fblo_",
                        w = 365 * 24 * 60 * 60 * 1e3,
                        x, y = null,
                    ...
                    function B(a, b, c) {
                        ...
                        var d = q.getUserID(),
                            e = "";
                        if (a)
                            if (a.userID) e = a.userID;
                            else if (a.signedRequest) {
                            var f = s.parse(a.signedRequest);
                            f && f.user_id && (e = f.user_id)
                        }
                        f = q.getLoginStatus();
                        var g = f === "unknown" && a || q.getUseCookie() && q.getCookieUserID() !== e,
                            h = d && !a;
                        d = a && d && d != e;
                        var i = a != x;
                        f = b != (f || "unknown");
                        q.setLoginStatus(b);
                        q.setAccessToken(a && a.accessToken || null);
                        q.setUserID(e);
                        x = a;
                        e = {
                            authResponse: a,
                    ...
                    function E(a, b, c) {
                        ...
                        return function(d) {
                            __p && __p();
                            if (d && d.access_token) {
                                var e = s.parse(d.signed_request);
                                b = {
                                ...
                                if (q.getUseCookie()) {
                                    ...
                                    var f = l.getDomain();
                                    !f && d.base_domain && l.setDomain("." + d.base_domain);
                                    l.setSignedRequestCookie(d.signed_request, e)
                                }
                                F();
                                f = "connected";
                                B(b, f)
                            } else(c === "logout" || c === "login_status") && (d && d.error && d.error === "not_authorized" ? (f = "not_authorized", B(null, f)) : d && d.error && d.error === "authorization_expired" ? (f = "authorization_expired", B(null, f, d.expired_user_id)) : (f = "unknown", B(null, f)), q.getUseCookie() && l.clearSignedRequestCookie(), c === "logout" && (G(), r.log("jssdk_error", {
                                appId: q.getClientID(),
                    ...
                    function H(a) {
                        ...
                        d = new t(j.resolve("www", !0) + "/connect/ping").setQueryData({
                            ...
                            version: q.getIsVersioned() ? q.getVersion() : null
                        });
                        b = m({
                            root: g.getRoot(),
                            name: k(),
                ...
                __d("FB", ["DOMWrapper", "GlobalCallback", "JSSDKConfig", "JSSDKCssConfig", "Log", "dotAccess", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.domReady", "sdk.ErrorHandling", "sdk.feature", "sdk.Insights", "sdk.Runtime", "sdk.Scribe"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    __p && __p();
                    var v, w, x = l(i, "api.mode"),
                        y, z = r("https_only_enforce_starting", !1),
                        ...
                        switch (e) {
                            ...
                            default:
                                return location.protocol !== "https:" && y && y[b] && z && z - ES("Date", "now", !1) <= 0 ? function() {
                                    ...
                                    var h = ES(Array.prototype.slice.call(arguments), "map", !0, g),
                                        i = a.apply(d, h),
                                        j, l = !0;
                ...
                __d("ApiClient", ["ApiBatcher", "ApiClientConfig", "ApiClientUtils", "Assert", "ChunkedRequest", "CORSRequest", "FlashRequest", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "UrlMap", "flattenObject"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
                    __p && __p();
                    var t, u, v, w = n.MAX_QUERYSTRING_LENGTH,
                        x = {
                            fql_query: !0,
                            fql_multiquery: !0,
                            friends_get: !0,
                ...
                __d("URI", ["PHPQuerySerializer", "ReloadPage", "URIBase", "areSameOrigin", "ifRequired", "isFacebookURI", "memoize", "unqualifyURI"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    __p && __p();
                    var o, p = m(function() {
                        return new s(window.location.href)
                    });
                    ...
                    function r(b, c, d, e) {
                        ...
                        !d && a.PageTransitions ? a.PageTransitions.go(f, e) : window.location.href === f ? h.now() : e ? b.location.replace(f) : b.location.href = f
                    }
                    b = babelHelpers.inherits(s, i);
                    o = b && b.prototype;
                    ...
                    s.prototype.setPath = function(a) {
                        "use strict";
                        this.path = a;
                    ...
                    s.prototype.setProtocol = function(a) {
                        "use strict";
                        this.protocol = a;
                        return o.setProtocol.call(this, a)
                    };
                    s.prototype.setDomain = function(a) {
                        "use strict";
                        this.domain = a;
                        return o.setDomain.call(this, a)
                    };
                    s.prototype.setPort = function(a) {
                        "use strict";
                        this.port = a;
                        return o.setPort.call(this, a)
                    };
                    s.prototype.setFragment = function(a) {
                        "use strict";
                        this.fragment = a;
                        return o.setFragment.call(this, a)
                    };
                    s.prototype.stripTrailingSlash = function() {
                        "use strict";
                    ...
                    s.prototype.isSubdomainOfDomain = function(a) {
                        "use strict";
                        __p && __p();
                        ...
                        if (ES(b, "endsWith", !0, a)) {
                            var c = b.length,
                                d = a.length,
                                e = c - d - 1;
                            if (c === d || b[e] === ".") return s.isValidURI(a)
                        }
                        return !1
                    };
                    s.prototype.getRegisteredDomain = function() {
                        "use strict";
                        if (!this.getDomain()) return "";
                    ...
                    s.prototype.getUnqualifiedURI = function() {
                        "use strict";
                        var a = new s(this);
                        n(a);
                        return a
                    };
                    s.prototype.getQualifiedURI = function() {
                        "use strict";
                        return new s(this).qualify()
                    };
                    s.prototype.isSameOrigin = function(a) {
                        "use strict";
                        a = a;
                        !a ? a = p() : a instanceof s || (a = new s(a.toString()));
                        return j(this, a)
                    };
                    s.go = function(a, b, c) {
                        "use strict";
                    ...
                    s.prototype.go = function(a, b) {
                        "use strict";
                        s.go(this, a, b)
                    };
                    s.tryParseURI = function(a) {
                        "use strict";
                        a = i.tryParse(a, g);
                        return a ? new s(a) : null
                    };
                    s.isValidURI = function(a) {
                        "use strict";
                        return i.isValid(a, g)
                    };
                    s.getRequestURI = function(a, b) {
                        "use strict";
                        a = a === undefined || a;
                        if (a) {
                            a = q();
                    ...
                    s.getMostRecentURI = function() {
                        "use strict";
                        var a = q();
                        return a ? a.getMostRecentURI().getQualifiedURI() : new s(window.location.href)
                    };
                    s.getNextURI = function() {
                        "use strict";
                        var a = q();
                        return a ? a.getNextURI().getQualifiedURI() : new s(window.location.href)
                    };
                    s.encodeComponent = function(a) {
                        "use strict";
                        return encodeURIComponent(a).replace(/%5D/g, "]").replace(/%5B/g, "[")
                    };
                    s.decodeComponent = function(a) {
                        "use strict";
                        return decodeURIComponent(a.replace(/\+/g, " "))
                    };
                    ...
                    var w = h.extend({
                        ...
                        x = {
                            ...
                            _createMobileLoader: function() {
                                var a;
                                p.nativeApp() ? a = '<div class="dialog_header"></div>' : x.isTabletStyle() ? a = '<div class="overlayLoader"><div id="fb_dialog_loader_spinner"></div><a id="fb_dialog_loader_close" href="#">' + n._("\ucde8\uc18c") + "</a></div>" : a = '<div class="dialog_header"><table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="' + n._("\ucde8\uc18c") + '"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         ' + n._("\uc77d\uc5b4\ub4e4\uc774\ub294 \uc911...") + '        </div>      </td>      <td class="header_right">      </td>    </tr>  </tbody></table></div>';
                                return x.create({
                    ...
                    var L = {
                        ...
                        checkOauthDisplay: function(a) {
                            ...
                            for (var c = 0; c < b.length; c++)
                                if (!g.initSitevars.iframePermissions[ES(b[c], "trim", !0)]) return "popup";
                            return a.display
                        },
                        prepareCall: function(a, b) {
                            ...
                            var c = a.method.toLowerCase(),
                                ...
                                e = m(),
                                f = C.getSecure() || c !== "auth.status" && c != "login.status";
                            ES("Object", "assign", !1, a, {
                            ...
                            (c === "parent" || c === "opener") && ES("Object", "assign", !1, g.params, {
                                channel_url: L._xdChannelHandler(e, c === "parent" ? "parent.parent" : "opener")
                            }, !0);
                            g = L.prepareParams(g);
                            return g
                        },
                        ...
                        _popupMonitor: function() {
                            __p && __p();
                            var a;
                            for (var b in L._loadedNodes)
                                if (Object.prototype.hasOwnProperty.call(L._loadedNodes, b) && b in L._defaultCb) {
                        ...
                        _xdChannelHandler: function(a, b) {
                            ...
                            return F.handler(function(b) {
                                ...
                                if (!c) return;
                                if (b.type == "resize") L._handleResizeMessage(a, b);
                ...
                __d("sdk.ui", ["Assert", "Log", "URI", "sdk.feature", "sdk.Impressions", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UIServer"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    __p && __p();
                    ...
                    function a(a, b) {
                        ...
                        g.isObject(a);
                        g.maybeFunction(b);
                        m.getIsVersioned() && (l.assertVersionIsSet(), a.version ? l.assertValidVersion(a.version) : a.version = m.getVersion());
                        a = ES("Object", "assign", !1, {}, a);
                        if (!a.method) {
                        ...
                        }(c == "permissions.request" || c == "permissions.oauth") && (a.display == "iframe" || a.display == "dialog") && (a.display = n.checkOauthDisplay(a));
                        ...
                        d && a.dialog.subscribe("e2e:end", function(a) {
                            a.method = c, a.display = e, h.debug("e2e: %s", ES("JSON", "stringify", !1, a)), k.log(114, {
                                payload: a
                            })
                        });
                        b(a);
                ...
                __d("legacy:fb.auth", ["sdk.Auth", "sdk.Cookie", "sdk.Event", "FB", "Log", "sdk.Runtime", "sdk.SignedRequest", "sdk.ui"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    ...
                    j.provide("", {
                        ...
                        if (l.getClientID())
                            if (a.authResponse) g.setAuthResponse(a.authResponse, "connected");
                ...
                __d("sdk.MBasicInitializer", ["UrlMap", "sdk.DOM", "sdk.fbt", "sdk.feature", "sdk.Runtime", "sdk.UA", "sdk.URI"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    ...
                    var n = function() {
                        ...
                        function a(a) {
                            ...
                            c.textContent = i._("Facebook\uc5d0 \uacf5\uc720");
                ...
                __d("sdk.Time", ["Log", "sdk.feature", "sdk.Impressions", "sdk.Runtime"], (function(a, b, c, d, e, f, g, h, i, j) {
                    ...
                    var k = window.performance,
                        l = k && "now" in k && "getEntriesByName" in k && h("log_perf", !1),
                        m, n = {};
                    if (l) {
                ...
                __d("IframePlugin", ["Log", "ObservableMixin", "QueryString", "Type", "UrlMap", "guid", "resolveURI", "sdk.Auth", "sdk.createIframe", "sdk.DOM", "sdk.Event", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.XD"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    ...
                    var E = j.extend({
                        constructor: function(a, b, c, d) {
                            ...
                            var f = k.resolve("www", !0) + "/plugins/" + c + ".php?",
                                g = {};
                ...
                __d("sdk.XFBML.CustomerChat", ["IframePlugin", "QueryString", "getDocumentScrollElement", "sdk.Content", "sdk.createIframe", "sdk.DialogUtils", "sdk.DocumentTitle", "sdk.DOM", "sdk.DOMEventListener", "sdk.Event", "sdk.UA", "sdk.XD"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
                    ...
                    a = g.extend({
                        constructor: function(a, b, c, d) {
                            n.addCss(a, "fb_invisible_flow"), n.remove(a), j.append(a), this.parent(a, b, c, d), this._iframeOptions.title = "", p.fire("customerchat.load"), this._setUpSubscriptions(a)
                        },
                        _setUpSubscriptions: function(a) {
                            ...
                            this.subscribe("xd.liveChatPluginGetBubbleIframe", ES(function(a) {
                                ...
                                z = ES("JSON", "parse", !1, a.passesAnimationGK), A = ES("JSON", "parse", !1, a.passesMobileRedesignGK), ES("JSON", "parse", !1, a.isMobile) ? this._handlePrepareMobileAnchorIframe(a) : this._handlePrepareDesktopAnchorIframe(a)
                            ...
                            }, "bind", !0, this)), p.subscribe("customerchat.load", ES(function() {
                        ...
                        _handleGetBubbleIframe: function(a) {
                            this._bubbleDialog = this._setupNewIframeDialog(a.fromIframe, ES("JSON", "parse", !1, a.isHTTPS)), v = this._bubbleDialog, j.append(this._bubbleDialog), this.subscribe("xd.liveChatPluginShowBubbleIframe", ES(function(a) {
                                n.setStyle(this._bubbleDialog, "display", "inline"), u && z && (n.addCss(this._bubbleDialog, "fb_customer_chat_bubble_pop_in"), ES("JSON", "parse", !1, a.dialogHidden) || setTimeout(ES(function() {
                                    D = !1, G(this._iframe, w, q.mobile(), !1)
                        ...
                        _handlePrepareDesktopAnchorIframe: function(a) {
                            this._iframe && (this._iframe.setAttribute("data-testid", "dialog_iframe"), ES("Object", "assign", !1, this._iframe.style, {
                                ...
                                width: "288pt",
                                zIndex: "2147483647"
                            }), n.setStyle(this._iframe, "maxHeight", ES("JSON", "parse", !1, a.dialogHidden) || u && z ? "0" : "100%"), ES("JSON", "parse", !1, a.chatStarted) && (w = !0, ES("Object", "assign", !1, this._iframe.style, {
                                height: "378pt"
                            })), x = this._iframe)
                        },
                        _handlePrepareMobileAnchorIframe: function(a) {
                            ...
                            if (this._iframe) {
                                ...
                                } else n.setStyle(this._iframe, "maxHeight", ES("JSON", "parse", !1, a.dialogHidden) || u && z ? "0" : "100%"), ES("JSON", "parse", !1, a.chatStarted) ? (w = !0, ES("Object", "assign", !1, this._iframe.style, {
                                    boxShadow: "none",
                                    height: "100%",
                                    right: "0",
                                    top: "0",
                                    width: "100%"
                                }), ES("JSON", "parse", !1, a.dialogHidden) || E()) : ES("Object", "assign", !1, this._iframe.style, {
                                    borderRadius: "9pt",
                                    bottom: "63pt",
                                    right: "3pt",
                                    top: "auto",
                        ...
                        _handleShadowUpdate: function(a) {
                            ES("JSON", "parse", !1, a.resetShadow) && this._bubbleDialog ? (n.setStyle(this._bubbleDialog, "borderRadius", "50%"), u && z ? n.addCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_no_badge") : n.setStyle(this._bubbleDialog, "boxShadow", "0px 3px 12px rgba(0, 0, 0, 0.15)")) : ES("JSON", "parse", !1, a.resetShadow) || this._setBubbleBadgeStyle()
                        },
                        ...
                        _handleExpandMobilePrompt: function() {
                            this._makeDialogIframeFullScreen(), E()
                        },
                        ...
                        _handleCustomerChatLoad: function(a) {
                            n.remove(a), n.remove(this._bubbleDialog)
                        },
                        _setupNewIframeDialog: function(a, b) {
                            a = "#" + h.encode({
                                forIframe: a
                            });
                            var c = l.setupNewDialog();
                            n.setStyle(c.contentRoot, "background", "none");
                            y = this._iframeOptions.name;
                            k({
                                url: r.getXDArbiterURL(b) + a,
                            ...
                            u && z ? (n.removeCss(c.dialogElement, "fb_customer_chat_bubble_animated_with_badge"), n.addCss(c.dialogElement, "fb_customer_chat_bubble_animated_no_badge")) : n.setStyle(c.dialogElement, "boxShadow", "0px 3px 12px rgba(0, 0, 0, 0.15)");
                            return c.dialogElement
                        },
                        _setBubbleBadgeStyle: function() {
                            this._bubbleDialog && (n.setStyle(this._bubbleDialog, "borderRadius", "50% 0% 50% 50%"), u && z ? (n.removeCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_no_badge"), n.addCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_with_badge")) : n.setStyle(this._bubbleDialog, "boxShadow", "-5px 4px 14px rgba(0, 0, 0, 0.15)"))
                        },
                    ...
                    function E() {
                        B = window.pageXOffset !== undefined ? window.pageXOffset : document.documentElement && document.documentElement.scrollLeft, C = window.pageYOffset !== undefined ? window.pageYOffset : document.documentElement && document.documentElement.scrollTop, n.addCss(document.body, "fb_mobile_overlay_active")
                    }

                    function F() {
                        n.removeCss(document.body, "fb_mobile_overlay_active"), window.scrollTo(B, C)
                    }
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"4142988","namespace":"FB","message":"' + e.message + '"}}');
}